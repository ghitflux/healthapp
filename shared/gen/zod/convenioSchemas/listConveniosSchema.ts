...
import { paginatedConvenioListListSchema } from "../paginatedConvenioListListSchema.ts";
import { z } from "zod/v4";

export const listConveniosQueryParamsSchema = z.object({
...
export const listConvenios200Schema = z.lazy(() => paginatedConvenioListListSchema)

export const listConveniosQueryResponseSchema = z.lazy(() => listConvenios200Schema)